...
#define TIME_BUTTON_POLL_MS (100U)  /* ms */
#define TIME_BUTTON_DEFAULTS_ACTIVATE_MS (5000U) /* ms */
#define TIME_BUTTON_NORMAL_PRESS (50U)   /* ms */
#define TIME_BUTTON_LONG_PRESS (1500U) /* ms */
